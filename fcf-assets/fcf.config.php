...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'https://formspree.io/f/mzboelly');
define('EMAIL_TO_NAME', 'Nirab');

define('EMAIL_TO_CC', 'arjan.waraich@icloud.com');
define('EMAIL_TO_CC_NAME', 'Arjan');

define('EMAIL_TO_BCC', '');
define('EMAIL_TO_BCC_NAME', '');

define('EMAIL_FROM', 'https://formspree.io/f/mzboelly');
define('EMAIL_FROM_NAME', 'Our Website(Using my email)');

define('EMAIL_REPLY_TO', 'FIELD:Email');
define('EMAIL_REPLY_TO_NAME', 'FIELD:Email');

define('EMAIL_SUBJECT_BEFORE', '');
define('EMAIL_SUBJECT', "New contact form website message");
